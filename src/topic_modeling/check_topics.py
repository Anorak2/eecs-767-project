...
# df.loc[df["top_score"] < threshold, "label"] = "social/general/other"
...
print(check_df)
check_df.to_csv("label_distribution2.csv", index=False)
...
print(movie_df)
movie_df.to_csv("movies_label_distribution2.csv", index=False)
...
print(prop_df)
prop_df.to_csv("label_proportions_by_month2.csv", index=False)
